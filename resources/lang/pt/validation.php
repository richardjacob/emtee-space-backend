...
return [
    ...
    */
    ...
    'custom_errors' => [
        'fill_required_fields'          => 'Preencha Campos obrigatórios',
        'max_guests_error'              => 'Por favor insira um valor menor ou igual a',
        'choose_from_autocomplete'      => 'Escolha a localização de autocomplete.',
        'exact_location_not_found'      => 'Localização exata não encontrada, por favor, pino no mapa.',
        'please_upload_one_photo'       => 'Faça o upload de pelo menos uma foto.',
        'enter_amount_greater_than_min' => 'Por favor, indique valor superior a quantidade mínima',
        'select_valid_times'            => 'Selecione Tempos válidos',
    ],
