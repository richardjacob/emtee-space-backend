...
return [
	...
	'home' => [
		...
		'desc' => 'Discover & Book Unique Spaces',
		'change_desc' => 'Work anywhere!',
		'title' => 'Welcome home',
		...
		'search' => 'Search',
		'explore_world' => 'Popular Venues',
		'close' => 'Close',
		'explore_desc' => 'See venues, all around the world.',
	...
	'your_listing' => [
		...
		'resubmit' => 'Resubmit',
		'listing_completed_desc0'=>'The Five Commandments For Great Hosting',
		
		'listing_completed_desc1'=>'Respond to requests quickly and professionally. This is key to starting great conversations and increasing conversions.
		',
		'listing_completed_desc2'=>'Always be transparent when describing your service to guests. Let people know about your listing as accurately as possible. Everyone values honesty, which will reflect positively on your business.',
		'listing_completed_desc3'=>'Treat guests the way you want to be treated. Help them feel right at home when hosting them, and the results will pay themselves off in profit.',
		'listing_completed_desc4'=>'Keep your workspace tidy to impress guests and nature your reputation. ',
		'listing_completed_desc5'=>'Never be late - This is the #1 golden rule! Make sure your space is set as described, and always deliver more than expected - never less.',
		'listing_completed_desc0_title'=>'This script needs to be shown right after placing a listing as a:',
		'listing_completed_desc1_title'=>'Communication: ',
		'listing_completed_desc2_title'=>'Honesty: ',
		'listing_completed_desc3_title'=>'Kindness: ',
		'listing_completed_desc4_title'=>'Cleanliness: ',
		'listing_completed_desc5_title'=>'Punctuality: ',
	],

	'your_reservations' => [
		'google_translate'=>'Click here to translate the conversation',
	...
	'reviews' => [
		'space_with_respect'=>'Did the guest treat your space with respect ?',
		'finish_overall'=>'How was the process from start to finish overall ?',
		'experience_with_guest'=>'How would you describe your experience with the guest ?',
		'use_the_space'=>'Did you have a positive experience using :site_name to book and use the space ?',
		'describe_your_experience'=>'How would you describe your experience with the space and its host ?',
		'shared'=>'Shared',
		'private'=>'Private',
		'host_descrip' 			=> 'What was it like to host this event organizer?',
		'private_guest' 		=> 'Thank your event organizer for visiting or offer some tips to help them improve for their next event.',
		...
		'no_review_desc' 		=> 'Reviews are written at the end of a booking through :site_name. Reviews you’ve received will be visible both here and on your public profile.',
		...
		'nobody_to_review' 		=> 'Nobody to review right now. Looks like it’s time for orgaine an event!',
		...
		'write_review_guest_desc1' => 'You and your space owner will only see your feedback from this event once you have both completed a review.',
		'write_review_guest_desc2' => 'An honest review will help your space owner provide a better experience, and it will help event organizers when they’re selecting a place to event.',
		...
		'required' 				=> 'required',
		'describe_your_exp_guest_desc' => 'Your review will be public on your profile and your space owner\'s listing page. If you have additional feedback that you don’t want to make public, you can share it with space owner on the next page.',
		'describe_your_exp_placeholder' => 'How did your space owner make you feel welcome? Was the listing description accurate? What was the neighborhood like?',
		'this_field_is_required' => 'This field is required',
		'500_words_left' => 'char left',
		'reached_500_words' => 'You\'ve reached the limit of 500 char',
		'private_host_feedback' => 'Private Space owner Feedback',
		'private_host_feedback_desc' => 'We won’t make it public and your feedback will only be shared with your space owner, :site_name employees and its service providers',
		'what_did_you_love_about_staying' => 'What did you love about organize an event in this space?',
		'how_host_improve' => 'How can your space owner improve?',
		'overall_exp' => 'Overall Experience',
		'guest_star_reviews_desc' => 'Your space owner will not know how you respond to these questions. Space owners only see an average of all of the star reviews they receive.',
		'accuracy' => 'Accuracy',
		'accuracy_desc1' => 'How accurately did the photos & description represent the actual space?',
		'accuracy_desc2' => 'Tell this space owner how they could make their listing page more accurate. We\'ll send them your suggestions.',
		'cleanliness' => 'Cleanliness',
		'cleanliness_desc1' => 'Was the space as clean as you expect a listing to be?',
		'cleanliness_desc2' => 'Tell this space owner how they could improve their cleanliness. We\'ll send them your suggestions.',
		'arrival' => 'Arrival',
		'arrival_desc1' => 'Did the space owner do everything within their control to provide you with a smooth arrival process?',
		'arrival_desc2' => 'Tell this space owner how they could make their event organizers arrival better. We\'ll send them your suggestions.',
		'amenities' => 'Amenities',
		'amenities_desc1' => 'Did your space owner provide everything they promised in their listing description?',
		'amenities_desc2' => 'Tell this space owner how they could improve their amenities. We\'ll send them your suggestions.',
		'communication' => 'Communication',
		'communication_desc1' => 'How responsive and accessible was the space owner before and during your event?',
		'communication_desc2' => 'Tell this space owner how they could improve their communication. We\'ll send them your suggestions.',
		'location' => 'Location',
		'location_desc1' => 'How appealing is the neighborhood? Consider safety, convenience, and desirability.',
		'location_desc2' => 'Tell this space owner how they could better describe their location. We\'ll send them your suggestions.',
		'value' => 'Value',
		'value_desc1' => 'How would you rate the value of the listing?',
		'value_desc2' => 'Tell this space owner how they could improve the value they provide. We\'ll send them your suggestions.',
		'would_you_recommend' => 'Would you recommend this Space?',
		'would_you_recommend_desc' => 'Your answer will not be posted on your profile or your space owner’s listing.',
		'no' => 'No',
		'yes' => 'Yes',
		'stayed_at' => 'Organize the event at',
		'write_review_host_desc1' => 'You and your event organizer will only see your feedback from this event once you have both completed a review.',
		'write_review_host_desc2' => 'Be honest so that you help your event organizer plan for future events on :site_name. Your review will also help other hosts know what to expect when they receive a reservation request from them.',
		...
		'private_guest_feedback_desc' => 'This feedback is just for your event organizer. We won’t make it public.',
		'cleanliness_host_desc' => 'Did the event organizer leave your space clean?',
		'communication_host_desc' => 'How clearly did the event organizer communicate their plans, questions, and concerns?',
		'observance_space_rules' => 'Observance of Space Rules',
		'observance_space_rules_desc' => 'Did the event organizer observe the space rules you provided?',
		'would_you_recommend_host_desc' => 'Your answer will not be posted on your profile or your event organizer’s profile.',
	],
	...
	'account' => [
		...
		'additional_document_format' => '(JPG or PNG format)',
	...
	'lys' => [
		...
		'basics_title' => 'Help Event Organizer to Find the Right Fit',
		'basics_title1' => 'Ready to place your space in the spotlight?',
		'basics_title2' => 'Let’s get down to business.',
		'basics_desc' => 'People searching on :site_name can filter by listing basics to find a space that matches their needs.',
		'basics_desc1' => 'People all over the world are searching for a space like yours! When they use :site_name to find you, they’ll have the option to filter search results by listing basic information to find a match. By carefully completing the questions in this section, you can help them achieve their goals and, in turn, maximize your chances of being found!',
		'basics_desc2' => 'Please complete the following information as accurately as possible to help people find your space.',
		'saving' => 'Saving',
		'removing' => 'Removing',
		'removed' => 'Removed',
		...
		'agree_house_rules' => 'Guests agree to your Space Rules before booking.',
		...
		'calendar_title' => 'Show Event organizers to When They Can Book',
		...
		'mobile_select_desc' => 'To Select times, hold and drag',
	],
	...
	'search' => [
		...
		'language_currency' => 'Terms, Privacy, Currency & More',
	...
	'rooms' => [
		...
		'review_other_properties' => 'This space owner has :count review for other properties.|This space owner has :count reviews for other properties.',
	...
	'referrals' => [
		...
		'when_they_travel' => 'when they book and',
	...
	'email' => [
		...
		'at' => 'at',
		'fullmessage' => 'plan for their booking by responding within 24 hours. Taking longer than 24 hours to respond could negatively impact your response rate.',
	...
	'host_dashboard' => [
		...
		'title' => 'Creative freedom at its finest',
		'breakdown' => 'breakdown',
	...
	'api' => [
		...
		'invalid_mail' 			=> 'Invalid Email Id',
		'link_send_to_mail' 	=> 'Reset password link send to your Email id',
		'email_exist' 			=> 'Email Already exist',
		'email_success' 		=> 'Email Validation Success',
		...
		'page_no_require' 		=> 'Page Number required',
		'listed_successful' 	=> 'Listed Successfully',
		'listed_successfully' 	=> 'Space Details Listed Successfully',
		'created_successfully' 	=> 'Space Created Successfully',
		'basics_listed'		 	=> 'Basics Step Details Listed Successfully',
		'setup_listed'		 	=> 'Setup Step Details Listed Successfully',
		'ready_host_listed'		=> 'Ready To Host Step Details Listed Successfully',
		'search_filters_listed'	=> 'Search filters Listed Successfully',
		'no_data_found'			=> 'No Data Found',
		'undefined_page_no' 	=> 'Undefined Page No',
		'space_not_available'	=> 'Space Not available',
		'space_id' 				=> 'Space Id',
		'page'	 				=> 'Page',
		'invalid_space_id' 		=> 'Invalid Space Id',
		'invalid_location' 		=> 'Invalid Location',
		'dates_not_available'	=> 'Dates Not Available',
		'cannot_book_own_listing'=> 'You Can Not Book Your Own Space',
		...
		'no_bookings_found'	 	=> 'No Booking Types Found',
		'booking_type_listed_success' => 'Booking Types Listed Sucessfully',
		'booking_details_listed_success' => 'Booking Details Listed Sucessfully',
		'invalid_booking_type'	=> 'Invalid Booking Type',
		'min_price' 			=> 'Space Price Must Be Minimum :minimum_price :currency',
		...
		'invalid_availability_time' => 'Please Choose Valid Times',
		'invalid_activity_price' => 'Please Enter Valid Amount',
		...
		'booking_successful'	=> 'Booking Successfully Completed',
		'booking_cancelled'		=> 'Booking Cancelled Successfully',
		'invalid_date_selection'=> 'Please Choose Valid Dates',
		'invalid_payment_data'	=> 'Invalid Payment Details',
		'wishlist_not_found'	=> 'Wishlist Not Found',
		'coupon_code_applied'	=> 'Coupon Code Applied Successfully',
		'coupon_code_removed'	=> 'Coupon Code Removed',
		'payment_not_completed'	=> 'Stripe Payment Not Completed',
		'page'	 				=> 'Page',
		'invalid_location' 		=> 'Invalid Location',
	],
	...
	'new_home' => [
		...
		'terms_privacy_more' 	=> 'Terms, Privacy, Currency & More',
		'see_space'				=> 'See Spaces',
		'bookings'				=> 'Bookings',
		'listings'				=> 'Listings',
		'footer'				=> 'Footer',
		'how_it_works_desc'		=> 'Find thousands of hosts with one-of-a-kind spaces where you can meet, create, or celebrate.',
		'how_it_works_desc1'	=> 'Browse the marketplace and tailor your search to your activity needs.',
		'how_it_works_desc2'	=> 'Once you find a perfect match, book the space and pay online through our easy-to-use payment system.',
		'how_it_works_desc3'	=> 'Create a memorable experience in a memorable space, and enjoy!',
		'find_space' 			=> 'Find a Space',
		'space'		 			=> 'Space',
	],
	...
	'host_dashboard' => [
		'hi_first_name' 		=> 'Hi :first_name!',
		'welcome_message' 		=> 'By sharing your space, you\'re creating a world where people can belong anywhere.',
		'no_guests_this_month' 	=> 'No Event Organizer\'s This Month',
		'title' 				=> 'Guess, how many Hours you\'ve hosted this year\'?',
		'breakdown' 			=> 'breakdown',
		'already_paid_out' 		=> 'already paid out',
		'expected_earnings' 	=> 'expected earnings',
		'total_paid_out_in' 	=> 'total paid out in',
		...
		'earn_Travel' 			=> 'Invite Friends, Earn Travel Credit!',
		'invite_friends'		=> 'Invite friends',
		'for_nights_in_month' 	=> 'for :count hours from :count1 Space in :month',
		'total_details' 		=> 'total details',
		'complete_your_profile_desc' => 'Upload a photo and write a short bio to help space owner get to know you before inviting you into their space.',
	],

	'new_space' => [
		'what_kind_of_space' 	=> 'What type of space do you have?',
		'maximum_guests'		=> 'Maximum number of guests',
		'back'					=> 'Back',
		'continue'				=> 'Continue',
		'continue1'				=> 'CONTINUE',
		'optional'				=> 'Optional',
		...
		'prev_bookings'			=> 'Previous Bookings',
		'no_current_bookings' 	=> 'You have no current bookings.',
		...
		'spaces'				=> 'Spaces',
		'select_activity'		=> 'Select your activity',
	],

	'steps' => [
		'the_basics'			=> 'The Basics',
		'basics_desc'			=> 'Space details, guests',
		'setup'					=> 'Setup',
		'setup_desc'			=> 'Photos, space description',
		'ready_to_host'			=> 'Get ready to host',
		'ready_to_host_desc'	=> 'Pricing, availability, booking settings',
		'tell_us_your_space'	=> ':first_name, tell us about your space',
		'more_you_share_get_book'=> 'The more you share, the faster you can get a booking',
		'listing_done_percent'	=> 'Your listing is :percent% done',
		'complete'				=> 'Complete',
		'steps_to_complete'		=> 'More Steps to Complete',
		'listing_completed'		=> 'Your listing is :percent% done.',
		'steps_to_complete1'		=> 'x more step to complete',
		'space_type_desc1'		=> 'Does your venue include multiple event areas? Create a separate listing for each area to make the most of your venue.',
		'space_type_desc1'		=> 'N.B. Does your space includes multiple event areas, like boardroom(s) or function hall(s)? If you want to get the most out of your venue and receive the most exposure, be sure to create a separate listing for each area. Customize each listing based on your target audience’s needs!.',
		'space_type_desc2'		=> 'For example - If you can host 3 different events simultaneously; on a rooftop, in a meeting room and in a studio, add each one as its own space listing (3 listings). Each listing can then be customized based on the specific area’s characteristics.',
		'num_rooms_desc1'		=> 'If you need help determining the capacity of your space, follow these guidelines:',
		'num_rooms_desc2'		=> 'Cocktail Parties (standing): 5-6 Sq. Ft./Person',
		'guest_acces_desc1'		=> 'Accessibility is important',
		'guest_acces_desc2'		=> 'for events that require loading in equipment, furniture, and props. Including these details helps event organizers come prepared.',
		'max_guests_desc1'		=> 'Make sure to include number of guests,',
		'max_guests_desc2'		=> 'Many Guests Search for space based on the maximum guests allowed in that Space.',
		'amenities_desc1'		=> 'Let event organizers know what’s already available at your space.',
		'amenities_desc2'		=> 'This will help prepare them for the event',
		'amenities_desc3'		=> 'People can filter their search according to the amenities they want.',
		'amenities_desc4'		=> 'Make sure to include everything you have to offer, even if it seems obvious.',
		'services_desc1'		=> 'Guests often search for spaces that can also provide additional services.',
		'services_desc2'		=> 'Highlight these if you provide them in-house and/or work with a list of preferred vendors.',
		'location_desc1'		=> 'Your Space Address will not be displayed publicly.',
		'location_desc2'		=> 'The exact location of your space will only be shared with an event organizer once you confirm the event.',
		'photos_desc1'			=> 'Showcase your space',
		'photos_desc2'			=> 'Include photos of all event areas that will be available. If you have a private space, don\'t forget the bathroom, kitchen, and even the front door.',
		'style_desc1'			=> 'Event organizers often search and filter by style',
		'style_desc2'			=> 'Including the right style tags can help connect you with the right bookings.',
		'feature_desc1'			=> 'The features that you select will show up as tags in your listing',
		'feature_desc2'			=> 'allowing event organizers to easily search for and find spaces with the features they’re looking for.',
		'rules_desc1'			=> 'In addition to the :site_name guidelines, event organizers must agree to your space rules before they book.',
		'description_desc1'			=> 'Keep it short, sweet, and friendly,',
		'description_desc2'			=> 'including this in your title can help your space stand out.',
		'activities_desc1'			=> 'Think about which type of events your space is most suitable for and what you’re willing to host.',
		'activities_desc2'			=> 'As you begin hosting events, you can always come back and edit this section based on your experience.',
		'activity_price_desc1'			=> 'To calculate your hourly rate try this',
		'activity_price_desc2'			=> 'Suppose your daily rate is $1000. Consider 8 hours a full day. Divide $1000/8 hours = $125 an hour.',
		'availability_desc1'			=> 'Guests often search for spaces that can also provide additional services.',
		'availability_desc2'			=> 'Highlight these if you provide them in-house and/or work with a list of preferred vendors.',
		'cancellation_desc1'			=> 'If Event Organizer cancels the booking,',
		'cancellation_desc2'			=> 'the amount will be sent to Event Organizer or Space Owner based on :site_name Cancellation Policy.',
	],

	'basics'  	=> [
		// 'is_your_space_fully_furnished'=>'Is your space fully furnished?',
		'is_your_space_fully_furnished'=>'Is your space fully furnished?*',
		'how_many_workstations'=>'How many working stations are available in your space?*',
		// 'how_many_workstations'=>'How many working stations do you offer?',
		'are_they_shared_or_private'=>'Are your working stations/desks shared or private?*',
		'is_this_your_first_time_of_renting_space'=>'Have you ever hosted your venue with a website like :site_name before?*',
		'number_of_rooms' 		=> 'Number of Rooms',
		'number_of_restrooms'	=> 'Number of Restrooms',
		'floor_number' 			=> 'Floor number',
		'if_applicable' 		=> '(if applicable)',
		'estimated_sqft' 		=> 'Estimated square footage of the available Space',
		'how_guest_can_access'	=> 'How can guests access your space',
		'other' 				=> 'Other',
		'what_amenities_offer'	=> 'What amenities does your space offer?',
		'what_services_offer'	=> 'What services and extras do you offer',
		'additional_services'	=> 'Additional information about services, packages and rates:',
		'create_space' 			=> 'Create Space',
		'save_continue' 		=> 'Save & Continue',
		'save_changes'	 		=> 'Save Changes',
		'unsaved_warning' 		=> 'There is some unsaved changes found.',
	],

	'location'	=> [
		'address_of_space'		=> 'What is the full address of your space?',
		'address'				=> 'Address',
		'address1'				=> 'Address Line #1:',
		'address2'				=> 'Address Line #2:',
		'enter_a_location'		=> 'Enter a location',
		'checkin_guidance'		=> 'Check-In Guidance',
		'checkin_guidance_desc'	=> 'Share any special instructions needed for organizers to access the space. e.g. door lock code, on-site manager.',
		'checkin_guidance_desc1'=> 'This information will only be shared upon booking confirmation.',
		'address_desc1'			=> 'Street, City, State, Country',
		'address_desc2'			=> 'Apt #, Floor #, etc.',
		'address_desc2'			=> 'Suburb, postal code, city',
		'address_desc2-map'			=> 'Note: Please mark your exact geo location in map',
	],

	'setup'  	=> [
		'style_described_as'	=> 'The style of your space can be described as',
		'special_features_have'	=> 'What special features does your space have?',
		'set_space_rules'		=> 'Set your Space Rules',
		'about_your_space'		=> 'Tell event organizers about your space',
		'about_your_space_desc'	=> 'Your description will appear in your space listing and will be the first introduction viewers have to your space.',
		'listing_title'			=> 'Your Listing Title',
		'cannot_delete'			=> 'Cannot Delete',
		'delete_warning_desc'	=> 'Space must have atleast One photo.',
	...
	'ready_to_host'  	=> [
		...
		'activities_in_your_space'	=> 'Which activities are welcome in your space?',
		'activities_desc'			=> 'Select activities from the lists below',
		'set_your_price'			=> 'Set your price',
		'hourly_rate'				=> 'Hourly Rate',
		'min_hours'					=> 'Min. Hours',
		'min_hours_tooltip'			=> 'Minimum num. of hours per booking',
		'minimum_hourly_price'		=> 'Minimum Hourly Rate is ',
		'full_day_rate'				=> 'Full day rate',
		'hour_to_day'				=> 'Consider after eight hours a full day',
		'open'						=> 'Open',
		'closed'					=> 'Closed',
		'all_hours'					=> 'All Hours',
		'set_hours'					=> 'Set Hours',
		'set_cancellation_policy'	=> 'Set your cancellation policy',
		'set_availability'			=> 'Set your space availability',
		'security_deposit'			=> 'Security Deposit',
		'booking_type'				=> 'Booking Type',
		'instant_book' 				=> 'Instant Book',
		'request_to_book'			=> 'Request to Host',
	],

	'space_detail'	=> [
		'check_in_guidence'=>'Check-in Guidance',
		'people'				=> 'People',
		'sq_ft'					=> 'sq ft',
		'acre'					=> 'Acres',
		'per_hour'				=> 'per hour',
		...
		'guest_access'			=> 'Guest Access',
		'services_offer'		=> 'Services Offered',
		'other_services_offer'	=> 'Other Services',
		'special_feature'		=> 'Special Features of the Space',
		'space_rules'			=> 'Space Rules',
		'min_booking_hours'		=> 'Minimum Booking Hours',
		'availability'			=> 'Space Availability',
		'all_day'				=> 'All day (24 hours)',
		...
		'the_space_owner'		=> 'The Space Owner',
		'about_space_owner'		=> 'About the Space Owner',
		'full_day_desc'			=> '8 hours',
	],

	'booking' 	=> [
		'total_hour'			=> 'Total Hour|Total Hours',
		'up_to'					=> 'Up To',
		'hour'					=> 'Hour|Hours',
		'to'					=> 'To',
		'rate' 					=> 'Rate',
		'times'					=> 'Times',
		'times_not_available' 	=> 'Those Times are not available',
		'something_went_wrong' 	=> 'Something Went Wrong. Please Try Again.',
		'invalid_details'	 	=> 'Invalid Details',
		'by_booking_this_space' => 'By booking this space you’re agreeing to follow :first_name\'s Space Rules.',
		'avg_hourly_rate' => 'Average hourly rate is rounded',
		'24_7_help' => 'This helps us run our platform and offer services like 24/7 support on your booking',
		'security_deposit_will_not_charge' => 'This amount will not be charged until Space Owner claims',
		'minimum_price_warning'	=> 'Minimum Price Must Be atleast :symbol:amount',
		'activity_removed_by_host'=> 'This Activity Removed by Host',
		'payment_description' => ':site_name typically releases your payout about 14 days after your event organizer\'s scheduled checkout time or after closing the disputes. For details, see your Transaction History.',
		'tell_about_your_event' => 'Tell :first_name About Your Event',
		'welcome_to_city' 		=> 'Welcome! Let me know if you have any queries & I\'m happy to assist you.',
	],

	'cancel_policy' => [
		'cancellation_policies' 		=> 'Cancellation Policies',
		'cancellation_policy' 			=> 'Cancellation Policy',
		'site_cancel_policy_description_content' => ':site_name allows space owners to choose among three standardized cancellation policies (Flexible, Moderate, and Strict) that we will enforce to protect both event organizers and space owners alike. Each listing and booking on our site will clearly state the cancellation policy. Event organizers may cancel and review any penalties by viewing their event plans and then clicking \'Cancel\' on the appropriate booking.',
		'flexible' 					=> 'Flexible',
		'moderate'					=> 'Moderate',
		'strict' 					=> 'Strict',
		...
		'booking_officially_cancelled_when_click_cancel_button' => 'A booking is officially canceled when the guests clicks the cancellation button on the cancellation confirmation page, which they can find in Dashboard > Your Bookings > Cancel.',
		'cancel_policy_may_supres_by_refund_safety_exceptions' => 'Cancellation policies may be superseded by the guests Refund Policy, safety cancellations, or extenuating circumstances. Please review these exceptions.',
		'flexible_full_refund_24_hours_prior_from_checkin_time' => 'For a full refund, cancellation must be made a full 24 hours prior to listing’s local check in time on the day of check in.',
		'flexible_first_day_non_refundable_less_than_24_hours' => 'If the event organizer cancels less than 24 hours before check-in, the first day is non-refundable.',
		'flexible_not_spent_24_hours_after_100%_refundable' => 'If the event organizer arrives and decides to leave early, the days not spent 24 hours after the official cancellation are 100% refunded.',
		'moderate_full_refund_5_days_prior_from_checkin_time' => 'For a full refund, cancellation must be made five full days prior to listing’s local check in time on the day of check in.',
		'moderate_less_than_5_days_in_advance_1st_day_50%_not' => 'If the event organizer cancels less than 5 days in advance, the first day is non-refundable but the remaining days will be 50% refunded.',
		'moderate_not_spent_50%_refunded' => 'If the event organizer arrives and decides to leave early, the days not spent 24 hours after the cancellation occurs are 50% refunded.',
		'strict_50%_refund_on_7_days_prior_checkin_time' => 'For a 50% refund, cancellation must be made seven full days prior to listing’s local check in time on the day of check in, otherwise no refund.',
		'strict_less_than_7_days_in_advance_no_refund' => 'If the event organizer cancels less than 7 days in advance, the days not spent are not refunded.',
		'strict_not_spent_days_no_refund' => 'If the event organizer arrives and decides to leave early, the days not spent are not refunded.',
		'flexible_desc' 			=> 'Full refund 1 day prior to arrival, except fees',
		'moderate_desc' 			=> 'Full refund 5 days prior to arrival, except fees',
		'strict_desc' 				=> '50% refund up until 1 week prior to arrival, except fees',
		'event_organizer_not_entitled' => 'Event organizer will not be entitled to any refund in respect of cancellations made not in accordance with the chosen cancellation policy.',
		'dispute_resolution' 		=> 'Dispute Resolution',
		'for_event_organizer' 		=> 'for cancellation by event organizer',
		'for_space_owner'	 		=> 'for cancellation by Space Owner',
		'guest_service_fee'	 		=> 'Guest Service Fee',
		'how_provide_notification'	=> 'How to provide notification of cancellation',
		'submit_through_site_only'	=> 'You must submit all cancellations through the :site_name platform. A Booking is officially canceled when the event organizer clicks the cancellation button on the cancellation confirmation page, which they can find in Dashboard > Your Bookings > Cancel.',
		'service_fee_non_refundable' => ':site_name charges an Event Organizer service fee for each transaction, This service fee is always non-refundable.',
		'dispute_resolution_desc' => ':site_name will mediate when necessary, and has the final say in all disputes.',
	],

	'new_email' => [
		'sent_you' 				=> 'sent you :symbol:travel_credit for your first booking',
		'discover_unique_place' => 'you can discover unique spaces to book from local hosts, all over the world.',
		'simply_sign_up_to_get' => 'Simply sign up to get :symbol:travel_credit off your first booking.',
		'fullmessage' 			=> 'plan for their booking by responding within 24 hours. Taking longer than 24 hours to respond could negatively impact your response rate.',
		'meet_your_space_owner' => 'Meet your Space Owner',
		'interested_in_event_organize' => 'saw you\'re interested to organize event at',
		'pre_approved_booking' 	=> 'and pre-approved your Booking for',
		'space_for' 			=> 'Space for',
		'space_owner_details'	=> 'Space Owner Details',
		'event_organizer_details'=> 'Event Organizer Details',
		'please_review_checkin' => 'Please review the details of your booking and contact your space owner to coordinate check-in time and key exchange.',
		'we_have_billed'		=> 'We\'ve billed the payment method you supplied for :currency_symbol:payout_amount, the full amount of the booking. The space owner will receive the payment from :site_name 14 days after checkout or based on cancellation policy if apply.',
		'space_for'				=> 'Space for',
		'space_details_updated'	=> 'Space Details updated for',
	],

	'warning' => [
		'token_expired' => 'The page has expired due to inactivity.Please refresh and try again.',
	],
	'new_trans' => [
		'Im_new_to_this' => ' No, I’m new to all this!',
		'i_have'=>'Yes, I’m experienced with space hosting.'
	],
