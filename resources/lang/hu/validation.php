...
return [
    ...
    */
    ...
    'custom_errors' => [
        'fill_required_fields'          => 'Kérjük, töltse Kötelező kitölteni',
        'max_guests_error'              => 'Adjon meg egy értéket Kevesebb mint vagy egyenlő',
        'choose_from_autocomplete'      => 'Kérjük, válasszon a Tartózkodási hely automatikus kiegészítésben.',
        'exact_location_not_found'      => 'Pontos hely nem található, kérjük Pin Térkép.',
        'please_upload_one_photo'       => 'Kérjük, töltsön fel adni legalább egy fényképet.',
        'enter_amount_greater_than_min' => 'Kérjük, adja meg nagyobb összeget, minimális mennyiségű',
        'select_valid_times'            => 'Kérjük, válasszon érvényes Times',
    ],
