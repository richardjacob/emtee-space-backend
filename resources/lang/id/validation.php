...
return [
    ...
    */
    ...
    'custom_errors' => [
        'fill_required_fields'          => 'Silahkan isi Diperlukan Bidang',
        'max_guests_error'              => 'Silahkan Masukkan Nilai Kurang dari atau sama dengan',
        'choose_from_autocomplete'      => 'Silakan Pilih Lokasi dari autocomplete.',
        'exact_location_not_found'      => 'Lokasi Exact Tidak Ditemukan, Silakan Pin pada Peta.',
        'please_upload_one_photo'       => 'Silakan upload minimal satu foto.',
        'enter_amount_greater_than_min' => 'Silahkan Masukkan jumlah lebih besar dari jumlah minimum',
        'select_valid_times'            => 'Silakan Pilih Hari Waktu',
    ],
