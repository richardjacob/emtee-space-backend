...
return [
    ...
    */
    ...
    'custom_errors' => [
        'fill_required_fields'          => 'กรุณากรอกข้อมูลจำเป็น',
        'max_guests_error'              => 'โปรดป้อนค่าน้อยกว่าหรือเท่ากับ',
        'choose_from_autocomplete'      => 'โปรดเลือกสถานที่จากการเติมข้อความอัตโนมัติ',
        'exact_location_not_found'      => 'สถานที่ตั้งที่แน่นอนไม่พบโปรดปักหมุดบนแผนที่',
        'please_upload_one_photo'       => 'โปรดอัปโหลดอย่างน้อยหนึ่งภาพ',
        'enter_amount_greater_than_min' => 'กรุณาใส่จำนวนมากกว่าจำนวนเงินขั้นต่ำ',
        'select_valid_times'            => 'กรุณาเลือกที่ถูกต้องไทม์',
    ],
