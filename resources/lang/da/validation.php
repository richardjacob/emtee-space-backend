...
return [
    ...
    */
    ...
    'custom_errors' => [
        'fill_required_fields'          => 'Udfyld venligst Påkrævede felter',
        'max_guests_error'              => 'Indtast venligst en værdi mindre end eller lig med',
        'choose_from_autocomplete'      => 'Vælg venligst sted fra autofuldførelse.',
        'exact_location_not_found'      => 'Præcis placering ikke fundet, venligst Pin Kort.',
        'please_upload_one_photo'       => 'Upload mindst ét ​​foto.',
        'enter_amount_greater_than_min' => 'Indtast venligst større beløb end minimumsbeløbet',
        'select_valid_times'            => 'Vælg venligst Gyldige Times',
    ],
