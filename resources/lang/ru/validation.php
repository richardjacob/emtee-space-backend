...
return [
    ...
    */
    ...
    'custom_errors' => [
        ...
        'max_guests_error'              => 'Пожалуйста, введите значение меньше или равно',
        'choose_from_autocomplete'      => 'Пожалуйста, выберите Расположение от автозаполнения.',
        'exact_location_not_found'      => 'Точное местоположение не найден, пожалуйста Pin на карте.',
        'please_upload_one_photo'       => 'Пожалуйста, загрузите по крайней мере одну фотографию.',
        'enter_amount_greater_than_min' => 'Пожалуйста, введите сумму, большую, чем минимальная сумма',
        'select_valid_times'            => 'Выберите Правильные раз',
    ],
