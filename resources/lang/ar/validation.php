...
return [
    ...
    */
    ...
    'custom_errors' => [
        ...
        'max_guests_error'              => 'الرجاء إدخال قيمة أقل من أو يساوي',
        'choose_from_autocomplete'      => 'يرجى اختيار الموقع من الإكمال التلقائي.',
        'exact_location_not_found'      => 'المكان بالضبط لم يتم العثور على، الرجاء دبوس على الخريطة.',
        'please_upload_one_photo'       => 'يرجى تحميل أتلست صورة واحدة.',
        'enter_amount_greater_than_min' => 'الرجاء إدخال كمية أكبر من الحد الأدنى للمبلغ',
        'select_valid_times'            => 'الرجاء اختيار تايمز صالح',
    ],
