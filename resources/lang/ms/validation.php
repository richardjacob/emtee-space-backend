...
return [
    ...
    */
    ...
    'custom_errors' => [
        'fill_required_fields'          => 'Sila isi Diperlukan Fields',
        'max_guests_error'              => 'Sila masukkan sesuatu Kurang daripada atau sama dengan',
        'choose_from_autocomplete'      => 'Sila Pilih Lokasi dari auto-lengkap.',
        'exact_location_not_found'      => 'Tepat Lokasi Not Found, Sila Pin Peta.',
        'please_upload_one_photo'       => 'Sila muat naik atleast satu gambar.',
        'enter_amount_greater_than_min' => 'Sila Masukkan jumlah yang lebih besar daripada jumlah minimum',
        'select_valid_times'            => 'Sila Pilih Times Sah',
    ],
