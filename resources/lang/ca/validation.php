...
return [
    ...
    */
    ...
    'custom_errors' => [
        'fill_required_fields'          => 'Ompli els camps obligatoris',
        'max_guests_error'              => 'Si us plau, introdueixi un valor inferior o igual a',
        'choose_from_autocomplete'      => 'Si us plau, triï la ubicació d\'autocompletar.',
        'exact_location_not_found'      => 'Localització exacta no trobat, si us plau xinxeta.',
        'please_upload_one_photo'       => 'Si us plau, puja almenys una foto.',
        'enter_amount_greater_than_min' => 'Si us plau, introdueixi quantitat més gran que la quantitat mínima',
        'select_valid_times'            => 'Si us plau seleccioni hores de validesa',
    ],
