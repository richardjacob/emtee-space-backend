...
return [
    ...
    */
    ...
    'custom_errors' => [
        'fill_required_fields'          => 'Παρακαλούμε συμπληρώστε Υποχρεωτικά πεδία',
        'max_guests_error'              => 'Παρακαλώ εισάγετε μια τιμή μικρότερη ή ίση με',
        'choose_from_autocomplete'      => 'Επιλέξτε Τοποθεσία από αυτόματης συμπλήρωσης.',
        'exact_location_not_found'      => 'Η ακριβής τοποθεσία δεν βρέθηκε, παρακαλώ καρφίτσα στο χάρτη.',
        'please_upload_one_photo'       => 'Παρακαλώ ανεβάστε atleast μία φωτογραφία.',
        'enter_amount_greater_than_min' => 'Παρακαλώ Εισάγετε το ποσό μεγαλύτερο από το ελάχιστο ποσό',
        'select_valid_times'            => 'Επιλέξτε Ισχύει Times',
    ],
