...
return [
    ...
    */
    ...
    'custom_errors' => [
        ...
        'max_guests_error'              => 'Anna pienempi tai yhtä suuri kuin',
        'choose_from_autocomplete'      => 'Valitse Sijainti ennakoivasta.',
        'exact_location_not_found'      => 'Tarkka sijainti ei löydy, ota tappi Kartta.',
        'please_upload_one_photo'       => 'Lataa atleast yksi valokuva.',
        'enter_amount_greater_than_min' => 'Anna määrää suuremman vähimmäismäärän',
        'select_valid_times'            => 'Valitse kelvolliset Times',
    ],
