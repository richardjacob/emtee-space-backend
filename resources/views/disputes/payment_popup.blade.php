                    ...
                    <section id="payment" class="checkout-main__section payment">
                        ...
                        <div class="payment-section">
                                ...
                                <div class="row" id="payment-type-select">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="payment-method grouped-field paypal">
                                            <div class="payment-logo paypal d-none">PayPal
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div id="payment-methods-content">
                                ...
                                <div class="payment-method paypal d-none {{ (@Session::get('payment')[$s_key]['payment_card_type']=='PayPal') ? 'active':''}}" id="payment-method-paypal">
