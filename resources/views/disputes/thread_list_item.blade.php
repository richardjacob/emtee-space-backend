<div class="row post mb-2">
    ...
    <div class="col-3 col-lg-2 text-center name_break user_msg_detail1">
        <div class="media-photo media-round">
            <img width="40" height="40" src="{{ $message->message_sender_details->get('profile_picture') }}" class="user-profile-photo">
        </div>
        <p style="margin-bottom: 0px;" class="text-truncate" title="{{$message->message_sender_details->get('name')}}">
