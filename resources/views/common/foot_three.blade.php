...
<script src="{{ URL::to('vendor/isotope/isotope.pkgd.js') }}"></script>
<script src="{{ URL::to('vendor/magnific-popup/jquery.magnific-popup.js') }}"></script>
<script src="{{ URL::to('vendor/slick/slick.js') }}"></script>
<script src="{{ URL::to('vendor/waypoints/jquery.waypoints.js') }}"></script>
...
<script src="https://maps.googleapis.com/maps/api/js?key={{ $map_key }}&libraries=places&callback=initAutocomplete"
                async defer></script>



<script src="{{ URL::to('vendor/app.js') }}"></script>
