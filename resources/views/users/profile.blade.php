      ...
      <div class="row">
        ...
        <div class="col-12 col-md-8 col-lg-9 profile-view-right mt-4 mt-md-0">
          ...
          <div class="profile-room-slides">
            @if(!$space->isEmpty() )
            <div class="my-4" ng-init="space_data={{$space}}">
              <h2 class="title-sm">
                @lang('messages.new_space.spaces')
              </h2>

              <ul class="profile-slider owl-carousel">
                <li ng-repeat="space in space_data">
                  <div class="pro-img">
                    <a href="@{{ space.link }}">
                      <img src="@{{ space.photo_name }}" />
                    </a>
                  </div>
                  <div class="pro-info">
                    <h4 class="text-truncate">
                      ...
                      <span>·</span>
                      <span>@{{ space.number_of_guests }} @choice('messages.home.guest',2) </span>
                    </h4>
                    <a href="@{{ space.link }}" title="@{{ space.name }}">
                      <h5 class="text-truncate"> @{{ space.name }} </h5>
                    </a>
                    <p class="price">             
                      <span ng-bind-html="space.activity_price.currency.symbol"></span>@{{ space.activity_price.hourly }}
                    ...
                    <div class="d-flex align-items-center">                                              
                      <span ng-bind-html="space.overall_star_rating"> </span>
                      <span class="review-count mx-2" ng-if="space.reviews_count > 0">
                        @{{ space.reviews_count }}
                      </span>
                      <span class="review-label" ng-if="space.overall_star_rating">
                        @{{ space.reviews_count_lang }}
                      </span>
                    </div>
                  </div>
                </li>
