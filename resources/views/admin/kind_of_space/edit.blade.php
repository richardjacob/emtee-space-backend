...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="{{ route('kind_of_space') }}">{{ $main_title }}</a></li>
    ...
    <div class="row">
      ...
      <div class="col-md-8 col-sm-offset-2">
        ...
        <div class="box box-info">
          ...
          <!-- /.box-header -->
          <!-- form start -->
          {!! Form::open(['url' => route('update_kind_of_space',['id' => $result->id]), 'class' => 'form-horizontal','id'=>'form','files'=>true]) !!}
          ...
          <div class="box-body">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                  ...
                  @if($result->image)
                    <img width="250" height="200" src="{{ $result->image }}">
                  @endif
                </div>
              </div>
          ...
          <div class="box-footer">
            ...
            <a href="{{ route('kind_of_space') }}" class="btn btn-default pull-left cancel" name="cancel" value="cancel">Cancel</a>
          </div>
          <!-- /.box-footer -->
          {!! Form::close() !!}
        </div>
