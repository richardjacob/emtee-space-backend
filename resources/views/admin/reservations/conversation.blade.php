  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"> Conversation Details</li>
      </ol>
    </section>
...
<div class="box-header with-border">
        ...
        <span class="horizontal-rule-wrapper">
        <span>
        <span>{{ $row->reservation->space->users->first_name }} {{ trans('messages.inbox.pre_approved_you') }} </span>
        <span>{{ $row->created_time }}</span>
        </span>
        </span>
        </div>
        ...
        <span class="horizontal-rule-wrapper">
        <span>
        <span>{{ $row->reservation->space->users->first_name }} {{ trans('messages.inbox.sent_special_offer') }} </span>
        <span>{{ html_string($row->special_offer->currency->symbol) }}{{$row->special_offer->price }}/{{ ucfirst(trans_choice('messages.space.night',1)) }}</span>
        </span>
        </span>
        </div>
        </div>
