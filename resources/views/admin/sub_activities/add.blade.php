    ...
    <div class="row">
      ...
      <div class="col-md-8 col-sm-offset-2">
        ...
        <div class="box box-info">
          ...
          <!-- /.box-header -->
          <!-- form start -->
          {!! Form::open(['url' => route('store_sub_activity'), 'class' => 'form-horizontal','id' => 'form','files'=>true]) !!}
          <div class="box-body">
            ...
            <div class="multiple_lang" >
              ...
              <div class="form-group">
                ...
                <div class="col-sm-6">
                  {!! Form::text('name[]', '', ['class' => 'form-control name-input', 'id' => 'input_name_1', 'placeholder' => 'Name']) !!}
              ...
              <div class="form-group">
                ...
                <div class="col-sm-6">
                  {!! Form::select('activity_id', $activities,'', ['class' => 'form-control', 'id' => 'input_activity_id','placeholder' => 'Select']) !!}
                </div>
              </div>
            </div>
