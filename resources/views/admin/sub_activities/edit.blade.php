...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="{{ $base_url }}">{{ $main_title }}</a></li>
    ...
    <div class="row">
      ...
      <div class="col-md-8 col-sm-offset-2">
        ...
        <div class="box box-info">
          ...
          <!-- /.box-header -->
          <!-- form start -->
          {!! Form::open(['url' => route('update_sub_activity',['id' => $result->id]), 'class' => 'form-horizontal','id'=>'form','files'=>true]) !!}
          <input type="hidden" value="{{ $result->id }}" id ="activity_id" name="lang_id[]">
          ...
          <div class="box-body">
            ...
            <div class="multiple_lang">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-6">
                  {!! Form::text('name[]', $result->name, ['class' => 'form-control name-input', 'id' => 'input_name', 'placeholder' => 'Name']) !!}
                  <span class="text-danger"> {{ $errors->first('name') }} </span>
                </div>
              </div>
              <div class="form-group">
                <label for="input_category" class="col-sm-3 control-label"> Activity <em class="text-danger">*</em></label>
                <div class="col-sm-6">
                  {!! Form::select('activity_id', $activities, $result->activity_id, ['class' => 'form-control', 'id' => 'input_activity_id','placeholder' => 'Select',]) !!}
                </div>
              </div>
            </div>
            ...
            <div class="multiple_lang_add">
              ...
              <div class="multiple_lang">
                <input type="hidden" value="{{ $langs->id }}" id ="activity_id" name="lang_id[]"">
                ...
                <div class="form-group">
                  <label for="input_name" class="col-sm-3 control-label">Name<em class="text-danger">*</em></label>
                  <div class="col-sm-6">
                    {!! Form::text('name[]',$langs->name, ['class' => 'form-control name-input', 'id' => 'input_name_'.$i, 'placeholder' => 'Name']) !!}
                  </div>
                </div>
          ...
          <div class="box-footer">
            ...
            <a href="{{ $base_url }}" class="btn btn-default pull-left cancel" name="cancel" value="cancel">Cancel</a>
          </div>
          <!-- /.box-footer -->
          {!! Form::close() !!}
        </div>
