          ...
          <div class="box box-info">
            ...
            {!! Form::open(['url' => ADMIN_URL.'/edit_review/'.$result[0]->id, 'class' => 'form-horizontal']) !!}
              ...
              <span class="text-danger">(*)Fields are Mandatory</span>
                ...
                <div class="form-group">
                  <label for="input_space_name" class="col-sm-3 control-label">Space Name</label>
                  <div class="col-sm-6">
                    {!! Form::text('space_name', $result[0]->space_name, ['class' => 'form-control', 'id' => 'input_room_name', 'readonly' => 'true']) !!}
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <label for="input_comments" class="col-sm-3 control-label">{{trans('messages.reviews.space_with_respect')}}
                    <em class="text-danger">*</em></label>
                  @else
                  <label for="input_comments" class="col-sm-3 control-label">{{trans('messages.reviews.use_the_space',['site_name'=>$site_name])}}

                    <em class="text-danger">*</em></label>
                    @endif
                  <div class="col-sm-6">
                    {!! Form::textarea('comments', $result[0]->comments, ['class' => 'form-control', 'id' => 'input_comments']) !!}
                    <span class="text-danger">{{ $errors->first('comments') }}</span>
                  </div>
                </div> 
                <div class="form-group">
                  <label for="input_comments" class="col-sm-3 control-label">{{trans('messages.reviews.finish_overall')}} <em class="text-danger">*</em></label>

                    <em class="text-danger">*</em></label>
                  <div class="col-sm-6">
                    {!! Form::textarea('comments2', $result[0]->comments2, ['class' => 'form-control', 'id' => 'input_comments']) !!}
                    <span class="text-danger">{{ $errors->first('comments2') }}</span>
                  </div>
                </div>
                <div class="form-group">
                  @if($result[0]->review_by=='host')
                  <label for="input_comments" class="col-sm-3 control-label">{{trans('messages.reviews.experience_with_guest')}} <em class="text-danger">*</em></label>
                  @else
                  <label for="input_comments" class="col-sm-3 control-label">{{trans('messages.reviews.describe_your_experience')}}
                    <em class="text-danger">*</em></label>
                    @endif
                  <div class="col-sm-6">
                    {!! Form::textarea('comments3', $result[0]->comments3, ['class' => 'form-control', 'id' => 'input_comments']) !!}
                    <span class="text-danger">{{ $errors->first('comments3') }}</span>
                  </div>
                </div>
