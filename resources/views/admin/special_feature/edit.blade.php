...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="{{ route('special_features') }}">{{ $main_title }}</a></li>
    ...
    <div class="row">
      ...
      <div class="col-md-8 col-sm-offset-2">
        ...
        <div class="box box-info">
          ...
          <!-- /.box-header -->
          <!-- form start -->
          {!! Form::open(['url' => route('update_special_feature',['id' => $result->id]), 'class' => 'form-horizontal','id'=>'form','files'=>true]) !!}
          ...
          <div class="box-body">
            ...
            <div class="multiple_lang_add">
              ...
              <div class="multiple_lang">
                <input type="hidden" value="{{ $langs->id }}" id ="special_feature_id" name="lang_id[]"">
          ...
          <div class="box-footer">
            ...
            <a href="{{ route('special_features') }}" class="btn btn-default pull-left cancel" name="cancel" value="cancel">Cancel</a>
          </div>
          <!-- /.box-footer -->
          {!! Form::close() !!}
        </div>
