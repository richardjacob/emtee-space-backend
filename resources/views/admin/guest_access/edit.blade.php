...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="{{ route('guest_access') }}">{{ $main_title }}</a></li>
    ...
    <div class="row">
      ...
      <div class="col-md-8 col-sm-offset-2">
        ...
        <div class="box box-info">
          ...
          <!-- /.box-header -->
          <!-- form start -->
          {!! Form::open(['url' => route('update_guest_access',['id' => $result->id]), 'class' => 'form-horizontal','id'=>'form','files'=>true]) !!}
          ...
          <div class="box-body">
            ...
            <div class="multiple_lang">
              ...
              <div class="form-group">
                <label for="input_lang_1" class="col-sm-3 control-label">Language<em class="text-danger">*</em></label>
                <div class="col-sm-6">
            ...
            <div class="multiple_lang_add">
              ...
              <div class="multiple_lang">
                ...
                <div class="form-group">
                  <label for="input_lang" class="col-sm-3 control-label">Language<em class="text-danger">*</em></label>
                  <div class="col-sm-6">
                    @foreach($language as $lang)
                      @php
                        $val[$lang->value]= $lang->name;
          ...
          <div class="box-footer">
            ...
            <a href="{{ route('guest_access') }}" class="btn btn-default pull-left cancel" name="cancel" value="cancel">Cancel</a>
          </div>
          <!-- /.box-footer -->
          {!! Form::close() !!}
        </div>
