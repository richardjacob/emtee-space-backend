    ...
    <div class="row">
      ...
      <div class="col-md-12">
        ...
        <div class="box box-info">
          ...
          <div class="box-body print_area" id="space" ng-show="space_report.length && !loading">
            <div class="text-center"><h4>Spaces Report (@{{ from }} - @{{ to }})</h4></div>
            <div class="table-responsive">
              <table class="table">
                <thead>
                  <th>Id</th>
                ...
                <tbody>
                  <tr ng-repeat="item in space_report">
                    <td>@{{ item.id }}</td>
                    <td>@{{ item.name }}</td>
                    <td>@{{ item.host_name }}</td>
                    <td>@{{ item.space_type_name }}</td>
                    <td>@{{ item.status }}</td>
                    <td>@{{ item.created_at }}</td>
                  </tr>
                </tbody>
          ...
          <div class="text-center" id="print_footer" ng-show="( users_report.length || space_report.length || reservations_report.length )&& !loading">
          ...
          <div class="text-center"  ng-show="!users_report.length && !space_report.length && !reservations_report.length && !loading">
            <h3>No results</h3>
          </div>
          <br>
        </div>
