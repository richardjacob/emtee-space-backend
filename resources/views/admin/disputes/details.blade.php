...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li>
                <a href="{{ route('admin.disputes') }}">Disputes
                </a>
            </li>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="box panel panel-success">
                                            <div class="panel-header">
                                                <div class="col-sm-12">
                                                    <h4>The final dispute amount the users concluded {{ html_string($dispute->currency_symbol) }} {{$dispute->dispute_amount}} will be paid to {{$dispute->user->first_name}}</h4>
                                                </div>
                                            </div>
                                ...
                                <div class="row row-space-2">
                                    <div class="col-sm-12">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-7">
                                                <p>{{$dispute->reservation->space->name}}</p>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-sm-5">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-7">
                                                <p>{{$dispute->reservation->checkin_with_time}}</p>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-sm-5">
                                            ...
                                            <div class="col-sm-7">
                                                <p>{{$dispute->reservation->checkout_with_time}}</p>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-sm-5">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-7">
                                                <p>{{ html_string($dispute->currency_symbol) }}{{ $dispute->reservation->security}}</p>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-sm-5">
                                            ...
                                            <div class="col-sm-7">
                                                <p>{{ html_string($dispute->currency_symbol) }}{{ $dispute->reservation->admin_host_payout }}</p>
                                            </div>
                                        </div>
