              ...
              <span class="text-danger">(*)Fields are Mandatory</span>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    ...
                    <img src="{{ $logo }}" style="margin-top: 10px; max-width: 50%; width: auto; height: 30px;">
                  </div>
                </div>
                <div class="form-group">
                  <label for="input_secondary_logo" class="col-sm-3 control-label">Secondary Logo</label>
                  <em>Size: 200x30</em>
                  <div class="col-sm-6">
                    {!! Form::file('email_logo', ['class' => 'form-control', 'id' => 'input_secondary_logo']) !!}
                    <span class="text-danger">{{ $errors->first('email_logo') }}</span>
                    <img src="{{ $email_logo }}" style="margin-top: 10px; max-width: 50%; width: auto; height: 30px;">
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    ...
                    <img src="{{ $favicon }}" style="margin-top: 10px; max-width: 50%; width: auto; height: 25px;">
                  </div>
                </div>
