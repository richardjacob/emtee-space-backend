  ...
  <div class="referrals-info my-4">
    <div class="container p-0">
      ...
      <div class="sent-referrals col-12 my-4">
        ...
        <div class="d-flex justify-content-between align-items-center border pl-3 pr-2 mb-2">
          <div class="profile-img hide-sm">
          ...
          <div class="card-body">
            <div class="row my-2 referred-row">
              <div class="referred-row-body d-flex justify-content-between align-items-center">
                <div class="ml-2 mr-2">
