...
@section('emails.main')
@php
$link = '<a href="'.route('admin.space').'" style="margin:0;padding:0;font-family:&quot;Helvetica Neue&quot;,&quot;Helvetica&quot;,Helvetica,Arial,sans-serif;color:#ff5a5f;text-decoration:none" target="_blank"> '.$name.' </a>'
@endphp
