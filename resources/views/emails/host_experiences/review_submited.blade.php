...
<br>
<a style="text-decoration: none;line-height: 1.3;color: #00848a!important;" href="{{ $url }}host/manage_experience/{{ @$space_id }}">{{ trans('messages.email.btn_edit_submission',[], null, $locale) }}</a>
</div>
