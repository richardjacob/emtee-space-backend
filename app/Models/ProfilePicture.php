...
class ProfilePicture extends Model
{
    ...
    public function getSrcAttribute()
    {
        ...
        else if($this->attributes['photo_source'] == 'Facebook') {
        ...
        if($src == '') {
            ...
            if(count($photo_src)>1) {
                ...
                $src = asset('images/users/'.$this->attributes['user_id'].'/'.@$picture_details['filename'].'_225x225.'.@$picture_details['extension']);
            }
            else {
                $options['secure']=TRUE;
                $options['height']=225;
