...
class Disputes extends Model
{
    ...
    protected $appends = ['user_or_dispute_user', 'created_at_view', 'inbox_subject', 'status_show', 'user_name','original_currency_code','dispute_amount'];

    protected $convert_fields = ['amount','final_dispute_amount'];
    ...
    {
        return $this->final_dispute_amount;
    }
