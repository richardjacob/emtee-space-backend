...
class AdminController extends Controller
{
    ...
    public function index()
    {
        ...
        $data['reservations_count'] = Reservation::count();//get without experience count
        $data['reservemin_count']= Reservation::where('status','=','Expired')->count();
        $data['reserve_minus_count']= $data['reservations_count']- $data['reservemin_count'];
        $data['space_count'] = Space::count();
        $data['today_users_count'] = User::whereDate('created_at', '=', date('Y-m-d'))->count();
        $data['today_reservations_count'] = Reservation::whereDate('created_at', '=', date('Y-m-d'))->where('status','!=','Expired')->count();//get without experience count
        $data['today_space_count'] = Space::whereDate('created_at', '=', date('Y-m-d'))->count();
