    ...
    public function index(Request $request)
    {
        ...
        else if($request->submit)
        {
            ...
            $rules = array(
                ...
                'logo'         => 'image|mimes:jpg,png,jpeg,gif,webp,svg',
                'email_logo'   => 'image|mimes:jpg,png,jpeg,gif,webp,svg',
                'favicon'   => 'image|mimes:jpg,png,jpeg,gif,webp,svg',
                'footer_cover_image'   => 'image|mimes:jpg,png,gif,webp,svg,jpeg',
                'help_page_cover_image'   => 'image|mimes:jpg,png,gif,webp,svg,jpeg',
