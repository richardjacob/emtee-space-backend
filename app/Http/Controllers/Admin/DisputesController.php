...
class DisputesController extends Controller
{
    ...
    */
    public function close(Request $request)
    {
        ...
        flash_message('success', 'The dispute has been successfully closed!');
    ...
    */
    ...
    function confirm_amount(Request $request)
    {
        ...
        $final_dispute_amount = currency_convert($dispute->getOriginal('currency_code'), $reservation->currency_code, $dispute->final_dispute_amount);
        ...
        flash_message('success', 'The payout details updated!');
        return redirect(ADMIN_URL.'/dispute/details/'.$dispute->id);
    }
