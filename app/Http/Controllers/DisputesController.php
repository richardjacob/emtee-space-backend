...
class DisputesController extends Controller
{
    ...
    */
    ...
    function accept_amount(Request $request)
    {
        ...
        $dispute->final_dispute_amount  = currency_convert($dispute->reservation->currency_code,$dispute->original_currency_code,$dispute->final_dispute_data->get('amount'));
    ...
    */
    public function pay_amount(Request $request)
    {
        ...
        $payment_data['paypal_price'] = currency_convert($dispute->currency_code, PAYPAL_CURRENCY_CODE, $final_dispute_data->get('amount'));
    ...
    public function pay_amount_success(Request $request)
    {
        ...
        if($dispute && @$dispute->payment_status != 'Completed' && $payment_data)
        {
            ...
            $final_dispute_data = $dispute->final_dispute_data;
            $paypal_price = currency_convert($dispute->currency_code, PAYPAL_CURRENCY_CODE, $final_dispute_data->get('amount'));
