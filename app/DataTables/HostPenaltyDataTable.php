...
{    
    ...
    public function query(HostPenalty $model)
    {
        return $model->join('space', function($join) {
                            $join->on('space.id', '=', 'host_penalty.space_id');
                        })
                        ...
                        ->select(['host_penalty.id as id', 'space.name as space_name', 'users.first_name as host_name', 'host_penalty.reservation_id', 'host_penalty.amount','host_penalty.remain_amount', 'host_penalty.status as status', 'host_penalty.created_at', 'host_penalty.updated_at', 'host_penalty.currency_code']);
    }
