...
{    
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('last_amount', function($disputes){
                $final_dispute_data = $disputes->final_dispute_data;
                return $final_dispute_data['amount'];
            })
    ...
    {
        return $model::with('user','currency','reservation.space')->get();
    }
    ...
    protected function getColumns()
    {
        return array(
            ...
            ['data' => 'reservation.space.name', 'name' => 'created_at', 'title' => 'Listing Name'],
            ['data' => 'reservation.created_at', 'name' => 'created_at', 'title' => 'Reservation Date'],
            ['data' => 'last_amount', 'name' => 'last_amount', 'title' => 'Amount'],
